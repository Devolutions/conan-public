...
function Invoke-TlkMerge {
    ...
    foreach ($CacheName in $CacheNames) {
        ...
        $PackageNames = Get-ChildItem -Directory "$CacheName/.conan/data" -Name
        foreach ($PackageName in $PackageNames) {
            ...
            Copy-Item -Path "./$CacheName/.conan/data/$PackageName/*" -Destination "$ConanDataPath/$PackageName" `
        ...
        foreach ($MetadataFile in $MetadataFiles) {
            $InputFile = "./$CacheName/.conan/data/$MetadataFile"
