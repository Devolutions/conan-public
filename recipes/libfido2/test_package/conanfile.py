...
class TestPackageConan(ConanFile):
    ...
    def test(self):
        ...
        for lib in libs:
            file_path = os.path.join(self.dependencies['libfido2'].package_folder, 'lib', lib)
        ...
        include_dir = os.path.join(self.dependencies['libfido2'].package_folder, 'include', 'fido')
