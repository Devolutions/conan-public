...
class TestPackageConan(ConanFile):
    ...
    def test(self):
        ...
        for lib in libs:
            file_path = os.path.join(self.dependencies['winpr'].package_folder, 'lib', lib)
        ...
        for header in headers:
            file_path = os.path.join(self.dependencies['winpr'].package_folder, 'include', 'winpr', header)
